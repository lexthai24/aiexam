...
- **สุ่มข้อสอบครั้งละ 100 ข้อ**: แต่ละรอบจะสุ่มลำดับใหม่ ไม่เรียงเหมือนเดิม และต่อให้มีข้อสอบ 200/1000 ข้อ ก็หยิบมาแค่ 100 ข้อต่อรอบ (การสุ่มเป็นแบบ deterministic ต่อรอบ — reload กลางคันลำดับไม่เปลี่ยน แต่กด "เริ่มทำใหม่" จะได้ชุด/ลำดับใหม่)
...
- **เพิ่มข้อสอบได้เรื่อยๆ**: เพิ่มใน `prisma/questions.ts` → `npm run seed` → `npm run pregenerate`
